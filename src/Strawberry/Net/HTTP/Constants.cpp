...
namespace Strawberry::Net::HTTP
{
    ...
    std::string Version::ToString() const
    {
        switch (*this)
        {
            case Version::VERSION_1_0: return "1.0";
            case Version::VERSION_1_1: return "1.1";
            case Version::VERSION_2: return "2";
            case Version::VERSION_3: return "3";
            default: std::abort();
        }
    }
} // namespace Strawberry::Net::HTTP
